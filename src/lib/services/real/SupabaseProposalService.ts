...
function toRow(p: Proposal): Record<string, unknown> {
  return {
    ...
    preliminary_notice_date: p.preliminaryNoticeDate ?? null,
    quote_sheet_created_at: p.quoteSheetCreatedAt ?? null,
    quote_sheet_url: p.quoteSheetUrl ?? null,
    quote_sheet_amount: p.quoteSheetAmount ?? null,
    verification_quote_sheet: p.verificationQuoteSheet ?? null,
    internal_approval_at: p.internalApprovalAt ?? null,
...
function fromRow(row: Record<string, unknown>): Proposal {
  return {
    ...
    preliminaryNoticeDate: (row.preliminary_notice_date as string | null) ?? undefined,
    quoteSheetCreatedAt: (row.quote_sheet_created_at as string | null) ?? undefined,
    quoteSheetUrl: (row.quote_sheet_url as string | null) ?? undefined,
    quoteSheetAmount: (row.quote_sheet_amount as number | null) ?? undefined,
    verificationQuoteSheet: (row.verification_quote_sheet as Proposal["verificationQuoteSheet"]) ?? undefined,
    internalApprovalAt: (row.internal_approval_at as string | null) ?? undefined,
