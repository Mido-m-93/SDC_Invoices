...
function toRow(inv: OutboundInvoice): Record<string, unknown> {
  return {
    ...
    verification_contract: inv.verificationContract ?? null,
    verification_proposal: inv.verificationProposal ?? null,
    verification_budget: inv.verificationBudget ?? null,
    verification_cash: inv.verificationCash ?? null,
...
function fromRow(row: Record<string, unknown>): OutboundInvoice {
  return {
    ...
    verificationContract: (row.verification_contract as OutboundInvoice["verificationContract"]) ?? undefined,
    verificationProposal: (row.verification_proposal as OutboundInvoice["verificationProposal"]) ?? undefined,
    verificationBudget: (row.verification_budget as OutboundInvoice["verificationBudget"]) ?? undefined,
    verificationCash: (row.verification_cash as OutboundInvoice["verificationCash"]) ?? undefined,
